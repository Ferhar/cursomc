...
import com.fernandohar.cursomc.domain.Pagamento;
import com.fernandohar.cursomc.domain.PagamentoComBoleto;
import com.fernandohar.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "fernando.henrique_93@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("12345678","99884563"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "fernando.hen.93@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
